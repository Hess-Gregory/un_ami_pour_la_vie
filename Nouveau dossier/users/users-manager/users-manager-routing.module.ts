...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'user-get/:id', data: { breadcrumb: 'Détail du membre' },  component: GetUserComponent},
            { path: 'user-update/:id', data: { breadcrumb: 'Modifier le membre' }, component: UpdateUserComponent},
            { path: 'user-delete/:id', data: { breadcrumb: 'Supprimer le membre' },  component: DeleteUserComponent},
            { path: 'user-add', data: { breadcrumb: 'Ajouter un membre' },  component: AddUserComponent}
        ]
    }
];
