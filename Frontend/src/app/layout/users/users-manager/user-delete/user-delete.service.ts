...
export class UserDeleteService {
  ...
  public deleteUser() {
    ...
    return this.httpClient
      ...
      .subscribe(
        success => {
          console.log('alertMsg service 1 success', this.alertMsg);
          ...
          this.deleteEnd = true;
          console.log('alertMsg service 2 success', this.alertMsg);
        },
        error => {
          ...
          console.log('alertMsg service 1 alert', this.alertMsg);
          this.errorConcat1 =
          ...
          console.log('alertMsg service 2 alert', this.alertMsg);
        }
      );
  }
}
