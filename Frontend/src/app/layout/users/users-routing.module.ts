...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'users-info', loadChildren: () => import('./users-info/users-info.module')
                .then(m => m.UsersInfoModule) },
            { path: 'user-manager', loadChildren: () => import('./users-manager/users-manager.module')
                .then(m => m.UsersManagerModule) },
            // { path: 'user-manager', loadChildren: () => import('./users-list/all-users.module')
            //     .then(m => m.AllUsersModule) },
            { path: 'admin-manager', loadChildren: () => import('./admin-manager/admin-manager.module')
                .then(m => m.AdminManagerModule) },
            { path: 'users-activate', loadChildren: () => import('./users-activate/users-activate.module')
                .then(m => m.UsersActivateModule) },
            { path: 'address-book', loadChildren: () => import('./address-book/address-book.module')
